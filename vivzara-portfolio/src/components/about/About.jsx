  ...
  return (
    <div className="wrapper">
      <div id="about" className="about">
        <img
          src="assets/images/femaleballooninsky.jpg"
          alt="female with balloon in sky"
        />
        <div className="aboutContent">
          <h1 className="label">Rising to the challenge</h1>
          <p>
          ...
          <p>
            Returning to work after having my two beautiful children, I decided
            it was time to rise to the challenge and learn to 'build' that
            optimal solution.
          </p>
          <p>
